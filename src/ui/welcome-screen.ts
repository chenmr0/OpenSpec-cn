...
function getWelcomeText(): string[] {
  return [
    ...
    chalk.dim('  • /codespec/* 斜杠命令'),
    '',
    chalk.white('设置后快速开始:'),
    `  ${chalk.yellow('/codespec/plan')}      ${chalk.dim('录入变更')}`,
    `  ${chalk.yellow('/codespec/apply')}      ${chalk.dim('严格实现')}`,
    `  ${chalk.yellow('/codespec/apply-quick')} ${chalk.dim('快速实现')}`,
    `  ${chalk.yellow('/codespec/archive')}    ${chalk.dim('归档变更')}`,
    '',
