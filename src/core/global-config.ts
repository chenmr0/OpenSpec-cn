...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'codespec';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'codespec';
 ...
 *
 * - All platforms: $XDG_DATA_HOME/codespec/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/codespec/
 * - Windows fallback: %LOCALAPPDATA%/codespec/
 */
