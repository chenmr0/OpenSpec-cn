...
2. **提出澄清问题** — 每次一个，了解目的/约束/成功标准，以及用户需求未充分澄清的部分
3. **提出 2-3 种方案** — 附带权衡分析和你的推荐
4. **编写规格文档（spec.md）** — 提取需求，编写 WHEN/THEN 场景，保存到 \`spec.md\`
5. **用户审查规格文档** — 在继续之前请用户审查 spec.md
6. **编写设计文档（design.md）** — 提取技术决策、架构、风险，保存到 \`design.md\`
7. **用户审查规格文档** — 在继续之前请用户审查 \`design.md\`
8. 过渡到 writing-plans
