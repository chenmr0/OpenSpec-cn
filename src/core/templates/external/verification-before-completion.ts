/**
 * Verification Before Completion External Skill Template
 *
 * Copied from superpowers-cn/skills/verification-before-completion.
 * This skill is always installed during init alongside other external skills.
 */
import type { SkillTemplate } from '../types.js';

const verificationInstructions = `# 完成前验证
