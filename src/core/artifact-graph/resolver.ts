...
export function getProjectSchemasDir(projectRoot: string): string {
  return path.join(projectRoot, 'codespec', 'schemas');
}
 ...
 * 1. Project-local: <projectRoot>/codespec/schemas/<name>/schema.yaml
 * 2. User override: ${XDG_DATA_HOME}/codespec/schemas/<name>/schema.yaml
