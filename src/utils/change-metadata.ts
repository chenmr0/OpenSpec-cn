...
const METADATA_FILENAME = '.codespec.yaml';
...
/**
 * Writes change metadata to .codespec.yaml in the change directory.
 *
...
/**
 * Reads change metadata from .codespec.yaml in the change directory.
 *
 * @param changeDir - The path to the change directory
 * @param projectRoot - Optional project root for project-local schema resolution
 ...
 * 2. Schema from .codespec.yaml metadata (if exists)
