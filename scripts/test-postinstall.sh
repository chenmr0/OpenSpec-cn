...
echo "======================================"
echo "Testing CodeSpec Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_CODESPEC_NO_COMPLETIONS="${CODESPEC_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should print tip about completions)"
echo "--------------------------------------"
unset CI
unset CODESPEC_NO_COMPLETIONS
...
echo "Test 3: CODESPEC_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export CODESPEC_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_CODESPEC_NO_COMPLETIONS" ]; then
  export CODESPEC_NO_COMPLETIONS="$ORIGINAL_CODESPEC_NO_COMPLETIONS"
else
  unset CODESPEC_NO_COMPLETIONS
fi
